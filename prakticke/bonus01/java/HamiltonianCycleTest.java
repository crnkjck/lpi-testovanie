...
public class HamiltonianCycleTest {
    ...
    public static boolean[][] randomGoodInput(int size) {
        boolean[][] m = new boolean[size][size];
        int[] path = IntStream.range(0, size).toArray();
    ...
    public static void main(String[] args) {
        ...
        t.test("random good 10", randomGoodInput(10), true);
